  ...
  return (
    <div className=" py-12 px-4 md:px-10 lg:px-20">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-3xl md:text-4xl font-bold text-blue-600 mb-4">About EduNite</h1>
        <p className="text-base-content text-base md:text-lg leading-relaxed mb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto mt-10">
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <h2 className="text-xl font-semibold text-blue-600 mb-2">Why EduNite?</h2>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <h2 className="text-xl font-semibold text-blue-600 mb-2">Who We Serve</h2>
          <p className="text-black text-sm leading-relaxed">
